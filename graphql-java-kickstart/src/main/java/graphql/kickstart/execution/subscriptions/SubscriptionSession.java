...
public interface SubscriptionSession {
   ...
   * implementations of the web container should make any application specific objects stored here java.io.Serializable,
   * or the object may not be recreated after a failover.
   *
